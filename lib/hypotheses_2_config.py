...
class Config:
    ...
    def __init__(self):
        ...
        self.INTERFERENCE_LEVEL = 0  # chance that at a given moment there is already a LoRa packet being sent on your channel, 
        ...
        self.MOVEMENT_SPEED = self.WALKING_METERS_PER_MIN
